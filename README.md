...
Create a new project by typing: scrapy startproject quotes  
Use cd quotes to get into the new quotes folder to scaffold the new spider  
### Scaffold the new spider  
Type: scrapy genspider quote quotes.toscrape.com/js/  
...
Copy the installation command at the top of the page: pip install scrapy-splash  
...
Like this: SPLASH_URL = 'http://localhost:8050/'  
